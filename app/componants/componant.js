...
const Componant = () => {
  return (
    ...
    <div className='flex justify-center items-center flex-col'>
        <h1 className="font-bold  items-center title-font text-3xl m-4 "> Codewear </h1>
        <h2 className="flex justify-center items-center text-sm"> wear the code </h2>
      </div>
      
      <section className ="text-gray-600 body-font">
  <div className ="container px-5 py-24 mx-auto">
    <div className ="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className ="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Our Best Products</h1>
      <p className ="lg:w-1/2 w-full leading-relaxed text-gray-500">Write the code - wear the code .</p>
    </div>
